...
from CustomWaterWorld import CustomWaterWorld
...
if __name__ == "__main__":
    ...
    if args.env == "flappy":
        ...
        env = CustomMonsterKong()
    elif args.env == "waterworld":
        env = CustomWaterWorld()
    ...
    for t in range(hyper_params["num-steps"]):
        ...
        if (
            ...
            np.savetxt(
                "rewards_per_episode.csv", episode_rewards, delimiter=",", fmt="%1.3f"
            )
